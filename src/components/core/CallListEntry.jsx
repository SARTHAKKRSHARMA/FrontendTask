    ...
    <div>
      {
        currPageCallList.length === 0 ? <div><p>No Records To Display</p></div> : (
          <div className=' flex flex-col gap-3 w-[100%] h-[100%] py-[5px]'>
            {
                currPage === "archieved" ? <div className=' w-[100%] py-3 rounded-md bg-[#AFB2BF] text-center cursor-pointer font-bold font-inter flex flex-row items-center gap-3 justify-center shadow-[0_1px_0_0_rgba(0,0,0,0.1)]'> <RiInboxUnarchiveFill/> <p>Unarchive All Calls</p></div> : <div className=' w-[100%] py-3 rounded-md bg-[#AFB2BF] text-center cursor-pointer font-bold font-inter flex flex-row items-center gap-3 justify-center'> <RiInboxArchiveFill /> <p>Archive All Calls</p></div>
            }
